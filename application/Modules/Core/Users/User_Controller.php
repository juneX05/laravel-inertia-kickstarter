...
class User_Controller extends Controller
{
    ...
    {
        return Inertia::render('Core/Users/' . $component, $props);
    }
    ...
    public function show($id) {
        ...
        return $this->render('Details',compact('user','user_permissions','permissions'));
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($request->has('id')) {
            User_Model::find($request->input('id'))->update($request->all());
    ...
    public function updateStatus(Request $request)
    {
        ...
        if ($request->input('key_id') == Auth::id()) {
            return redirect()->back();
        }

        if ($request->has('key_id')) {
            User_Model::find($request->input('key_id'))->update([
    ...
    public function resetUserPassword(Request $request)
    {
        ...
        if ($request->has('id')) {
            User_Model::find($request->input('id'))->update(
    ...
    public function destroy(Request $request)
    {
        ...
        if ($request->has('id')) {
            User_Model::find($request->input('id'))->delete();
            return redirect()->back();
        }
    }
}
