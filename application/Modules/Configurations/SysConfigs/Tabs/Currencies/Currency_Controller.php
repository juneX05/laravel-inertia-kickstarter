...
use Inertia\Inertia;
use Application\Modules\Configurations\SysConfigs\Tabs\Currencies\Currency_Model;
...
class Currency_Controller extends Controller
{
    public function index() {
        ...
        $data = Currency_Model::all();

        return $this->render('Index', ['data' => $data]);
    }

    public function render($component, $props) {
        return Inertia::render('Configurations/SysConfigs/Tabs/Currencies/' . $component, $props);
    }
    ...
    public function edit($id) {
        ...
        $Currencies = Currency_Model::where('id',$id)->first();
    ...
    public function store(Request $request)
    {
        ...
        Currency_Model::create($request->all());
    ...
    public function update(Request $request)
    {
        ...
        if ($request->has('id')) {
            Currency_Model::find($request->input('id'))->update($request->all());
    ...
    public function destroy(Request $request)
    {
        ...
        if ($request->has('id')) {
            Currency_Model::find($request->input('id'))->delete();
